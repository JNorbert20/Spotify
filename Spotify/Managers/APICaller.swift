...
final class APICaller {
    ...
    public func getNewReleaseas(completion: @escaping ((Result<NewReleasesResponse, Error>)) -> Void) {
    ...
    public func getRecommendations(genres: Set<String>, completion: @escaping (Result<RecommandationsResponse, Error>) -> Void) {
